...
const Products: React.FC = () => {
  ...
  const handleEditProduct = (product: Product) => {
    ...
    setValue('additionalOptions', product.additionalOptions || []);
    onOpen();
  };
            ...
            {products.length > 0 ? (
              ...
              {products.map((product) => (
                      <Tr key={product.id}>
                        ...
                        <Td>R$ {typeof product.price === 'string' ? parseFloat(product.price).toFixed(2) : Number(product.price).toFixed(2)}</Td>
                        <Td>
                          <Stack direction="row">
                            {product.isActive ? (
